...
Measured on 2026-07-19T04:09:39.524Z using the packaged Windows x64 application.
...
- Cold start: 1075 ms (limit 4000 ms) — PASS
- No-project idle working set: 314.95 MiB after 60 seconds (limit 400 MiB) — PASS
- Selected-project idle working set: 390.33 MiB after 60 seconds (limit 400 MiB) — PASS
- ui_core_footprint_bytes: 306.28 MiB
