...
export function SettingsWorkspace({ project, reducedMotion, getRuntimeInfo, onOpenRoute, onOpenOperations }: SettingsWorkspaceProps) {
  ...
  const copy = locale === 'ja' ? {
    ...
    displayIntro: 'この端末で実際に変更できる表示項目です。', language: '表示言語', languageDetail: '選択は次回起動後も保持されます。',
    ...
    displayIntro: 'Settings that can actually be changed on this device.', language: 'Display language', languageDetail: 'The selection is saved for the next launch.',
