...
test("pins exact dynamic-tool and turn-start approval methods and decision shapes", () => {
  assert.deepEqual(Object.keys(schema.server_requests), [
    "item/tool/call",
    "item/commandExecution/requestApproval",
    "item/fileChange/requestApproval"
  ]);
  assert.deepEqual(schema.server_requests["item/tool/call"].params_required, [
    "threadId", "turnId", "tool", "arguments", "callId"
  ]);
  assert.deepEqual(
