...
const SAFE_EVIDENCE_FIELDS = Object.freeze([
  ...
  "approval_response_phase"
]);
const APPROVAL_RESPONSE_FAILURE_PHASES = Object.freeze([
  "pre_provider",
...
function safeEvidence(evidence = {}) {
  if (Object.hasOwn(evidence, "approval_response_phase")
      && !APPROVAL_RESPONSE_FAILURE_PHASES.includes(evidence.approval_response_phase)) {
    throw new AdapterContractError("approval response failure phase is invalid");
  }
  const detached = {};
