...
| 設定 | 設定 | dock | locale、project snapshot、runtime info | 未設計sectionを短く表示 | section移動、言語変更、状態確認、Operations表示 | I4B可視UI実装済み、ユーザー確認待ち |
| Project Route | 設定 > 起動とproject | dock > 設定 | phase projection | 不足を明記 | 既存Routeを開ける | 入口移動済み、ユーザー確認待ち |
